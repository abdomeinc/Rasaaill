...
namespace Client.WPF.Helpers
{
    ...
    {
        public static IList<IconData> Icons = [];
        public static async Task ReadIconData()
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            string resourceName = "Client.WPF.Resources.Icons.IconsData.json";
            ...
            List<IconData>? icons = await JsonSerializer.DeserializeAsync<List<IconData>>(stream);

            if (icons is not null)
            {
                foreach (IconData icon in icons)
                {
                    icon.Icon = (Icon)Enum.Parse(typeof(Icon), icon.Name);
                }
            }
        ...
        public static string GetIconSymbol(Icon newValue)
        {
            string iconSymbol = Icons.FirstOrDefault(x => x.Icon == newValue)?.Character ?? string.Empty;
            return iconSymbol;
        }
