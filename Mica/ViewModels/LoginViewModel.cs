...
namespace Mica.ViewModels
{
    public partial class LoginViewModel : ViewModelBase
    {
        ...
        private readonly Client.Core.Comms.Services.Interfaces.IAuthService _authService;
        ...
        public LoginViewModel(ILogger<LoginViewModel> logger, Client.Core.Comms.Services.Interfaces.IAuthService authService, Services.Interfaces.INavigateService navigateService, Services.Interfaces.IUserStore userStore)
        {
            _logger = logger;
