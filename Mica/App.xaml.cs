...
namespace Mica
{
    ...
    public partial class App
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            _ = services.AddHttpClient<Client.Core.Comms.Services.Interfaces.IAuthService, Client.Core.Comms.Services.AuthService>(client =>
            {
                client.BaseAddress = new Uri("http://localhost:5000");
            });

            // Core services
            _ = services.AddSingleton<Client.Core.Comms.Services.Interfaces.ITokenStorageService, Client.Core.Comms.Services.TokenStorageService>();
